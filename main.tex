...
\begin{figure}
  \begin{tikzpicture}
    ...
    \draw[|-|] (3.2,3) arc (0:-90:3.2cm);
    \node[anchor=south] at (0,0) {\Strichmaxerl[5]};
    \node[below] at (2.6,.72) {$x$};
    \node at (1.35,1.65) {\faSoccerBallO};
  \end{tikzpicture}
...
Where $r$ is the distance from the center of the ship. This gives us
our first theorm for the ring world which is:
