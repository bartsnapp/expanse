...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{pour}
	\caption{}
	\label{fig:pour}
\end{figure}
...
The equations of projectile motion describe the path an object takes after being thrown. We will need to derive both the horizontal and vertical position of the object as a function of time. From the perspective of a ring world inhabitant, \textit{vertical} is defined as the distance from the floor of the ring and \textit{horizontal} is defined as the arc length counter clockwise or clockwise from the inhabitant. Thus the equations of motion for a projectile from the Ring World Inhabitant Perspective are:
...
Suppose an inhabitant of height $h$ de
